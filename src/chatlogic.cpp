...
ChatLogic::~ChatLogic()
{
    ...
    // delete all nodes --- Not needed anymore since the unique_ptr will delete it already
    /*for (auto it = std::begin(_nodes); it != std::end(_nodes); ++it)
    {
        delete *it;
    }*/ 

    // delete all edges --- Not needed anymore since the unique_ptr will delete it already
